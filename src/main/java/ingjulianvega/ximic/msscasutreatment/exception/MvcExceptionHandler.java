...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(TreatmentParameters treatmentParameters) {
        this.treatmentParameters = treatmentParameters;
    }
    ...
    public ResponseEntity<ApiError> validationErrorHandler(TreatmentException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(treatmentParameters.getApi())
