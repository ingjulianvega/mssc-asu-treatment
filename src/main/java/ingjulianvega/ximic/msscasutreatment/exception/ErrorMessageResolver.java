...
import ingjulianvega.ximic.msscasutreatment.configuration.TreatmentParameters;
...
public class ErrorMessageResolver {
    ...
    private final TreatmentParameters treatmentParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(treatmentParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(treatmentParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
